...
(1, 0, 0, 1, 5, 'admin', 'Plugin', 'default', '', '插件管理', 'cloud', '插件管理'),
...
(5, 0, 0, 1, 6, 'admin', 'Setting', 'default', '', '设置', 'cogs', '系统设置入口'),
...
(48, 108, 0, 1, 10000, 'admin', 'User', 'default', '', '员工组', '', '管理组'),
...
(108, 0, 0, 1, 3, 'user', 'AdminIndex', 'default', '', '用户管理', 'group', '用户管理'),
(109, 48, 1, 1, 10000, 'admin', 'User', 'index', '', '员工管理', '', '管理员管理'),
(110, 109, 1, 0, 10000, 'admin', 'User', 'add', '', '添加员工', '', '管理员添加'),
...
(119, 0, 0, 1, 1, 'chem', 'AdminIndex', 'default', '', '产品管理', 'flask', '产品管理'),
(120, 119, 1, 1, 4, 'chem', 'AdminBrand', 'index', '', '品牌管理', '', '品牌管理'),
(121, 120, 1, 0, 10000, 'chem', 'AdminBrand', 'add', '', '添加品牌', '', '添加品牌'),
(122, 120, 2, 0, 10000, 'chem', 'AdminBrand', 'addPost', '', '添加品牌提交保存', '', '添加品牌提交保存'),
(123, 120, 1, 0, 10000, 'chem', 'AdminBrand', 'edit', '', '编辑品牌', '', '编辑品牌'),
(124, 120, 2, 0, 10000, 'chem', 'AdminBrand', 'editPost', '', '编辑品牌提交', '', '编辑品牌提交'),
(125, 120, 2, 0, 10000, 'chem', 'AdminBrand', 'listOrder', '', '品牌排序', '', '品牌排序'),
(126, 120, 2, 0, 10000, 'chem', 'AdminBrand', 'delete', '', '删除品牌', '', '删除品牌'),
(127, 119, 1, 1, 3, 'chem', 'AdminCategory', 'index', '', '分类管理', '', '产品分类列表'),
(128, 127, 1, 0, 10000, 'chem', 'AdminCategory', 'add', '', '添加产品分类', '', '添加产品分类'),
(129, 127, 2, 0, 10000, 'chem', 'AdminCategory', 'addPost', '', '添加产品分类提交保存', '', '添加产品分类提交保存'),
(130, 127, 1, 0, 10000, 'chem', 'AdminCategory', 'edit', '', '编辑产品分类', '', '编辑产品分类'),
(131, 127, 2, 0, 10000, 'chem', 'AdminCategory', 'editPost', '', '编辑产品分类提交', '', '编辑产品分类提交'),
(132, 127, 1, 0, 10000, 'chem', 'AdminCategory', 'select', '', '文章分类选择对话框', '', '文章分类选择对话框'),
(133, 127, 2, 0, 10000, 'chem', 'AdminCategory', 'listOrder', '', '产品分类排序', '', '产品分类排序'),
(134, 127, 2, 0, 10000, 'chem', 'AdminCategory', 'delete', '', '删除产品分类', '', '删除产品分类'),
(135, 119, 1, 0, 10000, 'chem', 'AdminCompanyDiscount', 'index', '', '单位折扣管理', '', '单位折扣管理'),
(136, 119, 1, 1, 2, 'chem', 'AdminProduct', 'index', '', '产品管理', '', '产品管理'),
(137, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'add', '', '添加产品', '', '添加产品'),
(138, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'addPost', '', '添加产品提交', '', '添加产品提交'),
(139, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'edit', '', '编辑产品', '', '编辑产品'),
(140, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'editPost', '', '编辑产品提交', '', '编辑产品提交'),
(141, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'publish', '', '产品发布/取消发布', '', '产品发布/取消发布'),
(142, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'top', '', '产品置顶', '', '产品置顶'),
(143, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'recommend', '', '产品推荐', '', '产品推荐'),
(145, 196, 1, 1, 3, 'chem', 'AdminStoragePlace', 'index', '', '货架管理', '', '货架管理'),
(146, 145, 1, 0, 10000, 'chem', 'AdminStoragePlace', 'add', '', '添加货架', '', '添加货架'),
(147, 145, 2, 0, 10000, 'chem', 'AdminStoragePlace', 'addPost', '', '添加货架提交保存', '', '添加货架提交保存'),
(148, 145, 1, 0, 10000, 'chem', 'AdminStoragePlace', 'edit', '', '编辑货架', '', '编辑货架'),
(149, 145, 2, 0, 10000, 'chem', 'AdminStoragePlace', 'editPost', '', '编辑货架提交保存', '', '编辑货架提交保存'),
(150, 145, 2, 0, 10000, 'chem', 'AdminStoragePlace', 'delete', '', '删除货架', '', '删除货架'),
(151, 196, 1, 1, 4, 'chem', 'AdminWarehouse', 'index', '', '库房管理', '', '库房管理'),
(152, 151, 1, 0, 10000, 'chem', 'AdminWarehouse', 'add', '', '添加库房', '', '添加库房'),
(153, 151, 2, 0, 10000, 'chem', 'AdminWarehouse', 'addPost', '', '添加库房提交保存', '', '添加库房提交保存'),
(154, 151, 1, 0, 10000, 'chem', 'AdminWarehouse', 'edit', '', '编辑库房', '', '编辑库房'),
(155, 151, 2, 0, 10000, 'chem', 'AdminWarehouse', 'editPost', '', '编辑库房提交保存', '', '编辑库房提交保存'),
(156, 151, 2, 0, 10000, 'chem', 'AdminWarehouse', 'delete', '', '删除库房', '', '删除库房'),
(157, 0, 0, 1, 4, 'portal', 'AdminIndex', 'default', '', '门户管理', 'th', '门户管理'),
(158, 157, 1, 1, 10000, 'portal', 'AdminArticle', 'index', '', '文章管理', '', '文章列表'),
(159, 158, 1, 0, 10000, 'portal', 'AdminArticle', 'add', '', '添加文章', '', '添加文章'),
(160, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'addPost', '', '添加文章提交', '', '添加文章提交'),
(161, 158, 1, 0, 10000, 'portal', 'AdminArticle', 'edit', '', '编辑文章', '', '编辑文章'),
(162, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'editPost', '', '编辑文章提交', '', '编辑文章提交'),
(163, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'delete', '', '文章删除', '', '文章删除'),
(164, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'publish', '', '文章发布', '', '文章发布'),
(165, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'top', '', '文章置顶', '', '文章置顶'),
(166, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'recommend', '', '文章推荐', '', '文章推荐'),
(167, 158, 2, 0, 10000, 'portal', 'AdminArticle', 'listOrder', '', '文章排序', '', '文章排序'),
(168, 157, 1, 1, 10000, 'portal', 'AdminCategory', 'index', '', '分类管理', '', '文章分类列表'),
(169, 168, 1, 0, 10000, 'portal', 'AdminCategory', 'add', '', '添加文章分类', '', '添加文章分类'),
(170, 168, 2, 0, 10000, 'portal', 'AdminCategory', 'addPost', '', '添加文章分类提交', '', '添加文章分类提交'),
(171, 168, 1, 0, 10000, 'portal', 'AdminCategory', 'edit', '', '编辑文章分类', '', '编辑文章分类'),
(172, 168, 2, 0, 10000, 'portal', 'AdminCategory', 'editPost', '', '编辑文章分类提交', '', '编辑文章分类提交'),
(173, 168, 1, 0, 10000, 'portal', 'AdminCategory', 'select', '', '文章分类选择对话框', '', '文章分类选择对话框'),
(174, 168, 2, 0, 10000, 'portal', 'AdminCategory', 'listOrder', '', '文章分类排序', '', '文章分类排序'),
(175, 168, 2, 0, 10000, 'portal', 'AdminCategory', 'delete', '', '删除文章分类', '', '删除文章分类'),
(176, 157, 1, 1, 10000, 'portal', 'AdminPage', 'index', '', '页面管理', '', '页面管理'),
(177, 176, 1, 0, 10000, 'portal', 'AdminPage', 'add', '', '添加页面', '', '添加页面'),
(178, 176, 2, 0, 10000, 'portal', 'AdminPage', 'addPost', '', '添加页面提交', '', '添加页面提交'),
(179, 176, 1, 0, 10000, 'portal', 'AdminPage', 'edit', '', '编辑页面', '', '编辑页面'),
(180, 176, 2, 0, 10000, 'portal', 'AdminPage', 'editPost', '', '编辑页面提交', '', '编辑页面提交'),
(181, 176, 2, 0, 10000, 'portal', 'AdminPage', 'delete', '', '删除页面', '', '删除页面'),
(182, 157, 1, 1, 10000, 'portal', 'AdminTag', 'index', '', '文章标签', '', '文章标签'),
(183, 182, 1, 0, 10000, 'portal', 'AdminTag', 'add', '', '添加文章标签', '', '添加文章标签'),
(184, 182, 2, 0, 10000, 'portal', 'AdminTag', 'addPost', '', '添加文章标签提交', '', '添加文章标签提交'),
(185, 182, 2, 0, 10000, 'portal', 'AdminTag', 'upStatus', '', '更新标签状态', '', '更新标签状态'),
(186, 182, 2, 0, 10000, 'portal', 'AdminTag', 'delete', '', '删除文章标签', '', '删除文章标签'),
(187, 0, 1, 0, 10000, 'user', 'AdminAsset', 'index', '', '资源管理', 'file', '资源管理列表'),
(188, 187, 2, 0, 10000, 'user', 'AdminAsset', 'delete', '', '删除文件', '', '删除文件'),
(189, 108, 0, 1, 10000, 'user', 'AdminIndex', 'default1', '', '用户组', '', '用户组'),
(190, 189, 1, 1, 10000, 'user', 'AdminIndex', 'index', '', '本站用户', '', '本站用户'),
(191, 190, 2, 0, 10000, 'user', 'AdminIndex', 'ban', '', '本站用户拉黑', '', '本站用户拉黑'),
(192, 190, 2, 0, 10000, 'user', 'AdminIndex', 'cancelBan', '', '本站用户启用', '', '本站用户启用'),
(193, 189, 1, 1, 10000, 'user', 'AdminOauth', 'index', '', '第三方用户', '', '第三方用户'),
(194, 193, 2, 0, 10000, 'user', 'AdminOauth', 'delete', '', '删除第三方用户绑定', '', '删除第三方用户绑定'),
(195, 5, 1, 1, 10000, 'user', 'AdminUserAction', 'index', '', '用户操作管理', '', '用户操作管理'),
(196, 0, 0, 1, 2, 'chem', 'AdminIndex', 'defaultStock', '', '仓储物流', 'truck', '仓储物流'),
(197, 196, 1, 1, 2, 'chem', 'AdminStockIn', 'index', '', '产品入库', '', '产品入库'),
(198, 196, 1, 1, 1, 'chem', 'AdminStockOut', 'index', '', '产品出库', '', '产品出库'),
(199, 119, 1, 1, 1, 'chem', 'AdminPack', 'index', '', '产品检索', '', '产品检索'),
(200, 2, 1, 0, 10000, 'admin', 'Hook', 'sync', '', '同步钩子', '', '同步钩子'),
(201, 135, 2, 0, 10000, 'chem', 'AdminCompanyDiscount', 'setDiscount', '', '设置单位品牌折扣', '', '设置单位品牌折扣'),
(202, 199, 2, 0, 10000, 'chem', 'AdminPack', 'savePost', '', '产品包装提交保存', '', '产品包装提交保存'),
(203, 199, 2, 0, 10000, 'chem', 'AdminPack', 'delete', '', '产品包装删除', '', '产品包装删除'),
(204, 199, 1, 0, 10000, 'chem', 'AdminPack', 'inventoryChange', '', '产品包装库存更新', '', '产品包装库存更新'),
(205, 199, 2, 0, 10000, 'chem', 'AdminPack', 'inventoryChangePost', '', '产品包装库存更新提交保存', '', '产品包装库存更新提交保存'),
(206, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'packs', '', '产品包装列表', '', '产品包装列表'),
(207, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'select', '', '产品选择', '', '产品选择'),
(208, 136, 2, 0, 10000, 'chem', 'AdminProduct', 'addToOrderDraft', '', '添加产品到订单草稿', '', '添加产品到订单草稿'),
(209, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'import', '', '产品导入', '', '产品导入'),
(210, 136, 1, 0, 10000, 'chem', 'AdminProduct', 'importPost', '', '产品导入提交', '', '产品导入提交'),
(211, 197, 1, 0, 10000, 'chem', 'AdminStockIn', 'logs', '', '产品入库记录', '', '产品入库记录'),
(212, 197, 1, 0, 10000, 'chem', 'AdminStockIn', 'add', '', '添加产品入库', '', '添加产品入库'),
(213, 197, 1, 0, 10000, 'chem', 'AdminStockIn', 'edit', '', '编辑产品入库', '', '编辑产品入库'),
(214, 197, 1, 0, 10000, 'chem', 'AdminStockIn', 'selectPack', '', '产品入库选择产品包装', '', '产品入库选择产品包装'),
(215, 197, 2, 0, 10000, 'chem', 'AdminStockIn', 'inventoryChangePost', '', '产品入库产品库存更改', '', '产品入库产品库存更改'),
(216, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'logs', '', '产品出库记录', '', '产品出库记录'),
(217, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'add', '', '添加产品出库', '', '添加产品出库'),
(218, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'addPost', '', '添加产品出库提交', '', '添加产品出库提交'),
(219, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'edit', '', '编辑产品出库', '', '编辑产品出库'),
(220, 198, 2, 0, 10000, 'chem', 'AdminStockOut', 'editPost', '', '编辑产品出库提交', '', '编辑产品出库提交'),
(221, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'printStockOut', '', '打印产品出库', '', '打印产品出库'),
(222, 198, 2, 0, 10000, 'chem', 'AdminStockOut', 'confirm', '', '产品出库确认', '', '产品出库确认'),
(223, 198, 1, 0, 10000, 'chem', 'AdminStockOut', 'selectPack', '', '产品出库选择产品包装', '', '产品出库选择产品包装'),
(224, 198, 2, 0, 10000, 'chem', 'AdminStockOut', 'addToStockOut', '', '添加产品到出库', '', '添加产品到出库'),
(225, 195, 1, 0, 10000, 'user', 'AdminUserAction', 'edit', '', '编辑用户操作', '', '编辑用户操作'),
(226, 195, 2, 0, 10000, 'user', 'AdminUserAction', 'editPost', '', '编辑用户操作提交', '', '编辑用户操作提交'),
(227, 195, 1, 0, 10000, 'user', 'AdminUserAction', 'sync', '', '同步用户操作', '', '同步用户操作');
...
(1, 1, 1, 8, 'ChemCMS官网', 'http://www.chemcms.com', 'ChemCMS', '', '_blank', '');
...
-- ----------------------------
--  Table structure for `cmf_chem_category`
-- ----------------------------
CREATE TABLE `cmf_chem_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `description` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '分类描述',
  `path` varchar(255) NOT NULL DEFAULT '' COMMENT '分类层级',
  `seo_title` varchar(100) NOT NULL DEFAULT '',
  `seo_keywords` varchar(500) NOT NULL DEFAULT '',
  `seo_description` varchar(500) NOT NULL DEFAULT '',
  `list_tpl` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '分类列表模板',
  `one_tpl` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '分类产品页模板',
  `more` text CHARACTER SET utf8 COMMENT '扩展属性',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品分类表';

-- ----------------------------
--  Table structure for `cmf_chem_category_product`
-- ----------------------------
CREATE TABLE `cmf_chem_category_product` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品id',
  `list_order` float NOT NULL DEFAULT '0' COMMENT '排序',
  `status` tinyint(3) unsigned DEFAULT '1' COMMENT '状态;1:发布;0:下架',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品分类对应表';

-- ----------------------------
--  Table structure for `cmf_chem_company_discount`
-- ----------------------------
CREATE TABLE `cmf_chem_company_discount` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `company_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公司 id',
  `brand_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '品牌 id',
  `discount` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '折扣,最大100',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='单位品牌折扣表';

-- ----------------------------
--  Table structure for `cmf_chem_product`
-- ----------------------------
CREATE TABLE `cmf_chem_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '用户 id',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品上传时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品发布时间',
  `delete_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '删除时间',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态;1:发布;0:下架',
  `recommended` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '推荐;1:推荐,0:不推荐',
  `likes` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '喜欢数',
  `hits` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '点击量',
  `is_top` tinyint(4) NOT NULL DEFAULT '0' COMMENT '置顶;1:置顶;0:不置顶',
  `comment_count` int(10) unsigned NOT NULL DEFAULT '0',
  `name` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '产品名称',
  `cn_name` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '产品中文名',
  `thumbnail` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '缩略图',
  `keywords` varchar(255) NOT NULL DEFAULT '' COMMENT '产品关键字',
  `description` varchar(500) NOT NULL DEFAULT '' COMMENT '产品描述',
  `cas` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT 'cas号',
  `mdl` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT 'MDL',
  `mol_formula` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '分子式',
  `mol_weight` double NOT NULL DEFAULT '0' COMMENT '摩尔量',
  `content` text CHARACTER SET utf8 COMMENT '产品内容描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品表';

-- ----------------------------
--  Table structure for `cmf_chem_product_inventory_log`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `cmf_chem_product_pack`
-- ----------------------------
CREATE TABLE `cmf_chem_product_pack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '产品名',
  `product_no` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '产品编号',
  `price` decimal(10,0) NOT NULL DEFAULT '0' COMMENT '价格',
  `inventory` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '库存',
  `storage_place` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品存放在哪里',
  `pack` int(11) NOT NULL DEFAULT '0' COMMENT '每个包装的量',
  `unit` varchar(10) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '单位,mg/g/ml/kg/l/t',
  `packing_material` varchar(20) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '包装形式，比如：瓶',
  `purity` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '纯度',
  `brand` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '产品品牌',
  `provider` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '供应商',
  `lead_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '备货期,单位是天,有现货可填0',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品上传时间',
  `update_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '产品发布时间',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态;1:发布;0:下架',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品规格表';

-- ----------------------------
--  Table structure for `cmf_chem_stock_out`
-- ----------------------------
CREATE TABLE `cmf_chem_stock_out` (
  ...
  `stock_out_sn` varchar(20) DEFAULT '' COMMENT '出库单号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品出库表';

-- ----------------------------
--  Table structure for `cmf_chem_stock_out_item`
-- ----------------------------
CREATE TABLE `cmf_chem_stock_out_item` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `stock_out_sn` varchar(20) NOT NULL DEFAULT '' COMMENT '出库单号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
--  Table structure for `cmf_chem_storage_place`
-- ----------------------------
CREATE TABLE `cmf_chem_storage_place` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `warehouse_id` int(11) NOT NULL DEFAULT '0' COMMENT '库房 id',
  `name` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '库位名称',
  `remark` varchar(100) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='产品存放处';

-- ----------------------------
--  Table structure for `cmf_chem_warehouse`
-- ----------------------------
CREATE TABLE `cmf_chem_warehouse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
